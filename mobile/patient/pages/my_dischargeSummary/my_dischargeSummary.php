<?php
    ...
    function get_my_dischargeSummary($data){
      //print_r($data);
    ...
    //   $result = get_mrn($patient_mrn);
  	...
  	function get_booking_report($mrn){
  				...
  				$url = "https://live.mednetlabs.com/mxServer/ws/onlineDoctorsAppointment/myDischargeSummary";
  				// $url = "https://demo.mednetlabs.com/mxServer/ws/onlineDoctorsAppointment/myDischargeSummary";
  				$global_header = array(
  				...
  				if($result["data"]){
                    ...
                    foreach($result["data"] as $i => $row){
                      ...
                      $a ='{
                        ...
                        "sub_text": "Name - '.$row['patientName'].' \nDate - '.date("d M Y",strtotime($row['formattedAdmissionDate'])).'" ,
                        "sub_text_1": "'.date("d M Y",strtotime($row['formattedDischargeDate'])).'",
                        "click_action": "2",
                        "timestamp": "",
                        "next_page": {
                            "page_code": "pdf_view",
